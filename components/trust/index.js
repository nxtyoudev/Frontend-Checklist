        ...
        <div className='px-[50px]'>
          ...
          <div className='flex gap-4 md:gap-8 mt-12 flex-col md:flex-row'>
            <a href="https://formular.mg-pools.de/start/" target="_blank">
              <button className='md:w-auto w-full text-center md:text-left flex items-center md:justify-start justify-center text-white gap-4 bg-[#1E75EE] md:pl-4 md:pr-8 py-5 border border-[#1E75EE]'>
