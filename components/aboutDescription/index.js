...
export default () => (
	<div className='md:mt-[114px] mt-[44px] md:px-[100px] px-4'>
		...
		<div className="md:mt-[69px] mt-[30px] flex md:flex-row flex-col md:justify-center justify-start items-center md:gap-[90px] gap-2.5">
